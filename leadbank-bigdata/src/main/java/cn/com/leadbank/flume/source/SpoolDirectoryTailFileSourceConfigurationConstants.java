...
public class SpoolDirectoryTailFileSourceConfigurationConstants {
	...
	public static final String SPOOL_DIRECTORY_DEF = "/leadbank/logs/mgws";
	...
	public static final String BACKUP_FILEDATE_FORMAT = "backupFileDateFormat";
	public static final String DEFAULT_BACKUP_FILEDATE_FORMAT = "yyyy-MM-dd";
	
	public static final String LOG_FILENAME = "logFilename";
	public static final String DEFAULT_LOG_FILENAME = "mgws.log";
	
	/** Directory to store metadata about files being processed. **/
	public static final String TRACKER_DIR = "trackerDir";
	public static final String DEFAULT_TRACKER_DIR = "/test/monitor/";
